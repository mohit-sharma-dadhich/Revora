...
import { BarChart3, BrainCircuit, ChevronLeft, CircleDollarSign, ClipboardList, FlaskConical, Gauge, GitBranch, History, Lightbulb, Menu, Network, Scale, Settings2, Sparkles, Upload, X } from 'lucide-react'
...
function ArchitectureDiagram() {
  ...
  return (
    <div className="relative mt-14 overflow-hidden rounded-xl border border-line bg-[#0d0e0f] p-4 sm:p-6">
      <div className="mb-5 flex items-center justify-between px-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-[#626873]"><span>Revenue operating loop</span></div>
