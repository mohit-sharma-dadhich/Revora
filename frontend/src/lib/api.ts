...
export type OpportunityDataSource = 'demo' | 'private' | 'auto'
...
export function listOpportunities(limit = 5, dataSource: OpportunityDataSource = 'auto'): Promise<{ opportunities: Opportunity[] }> {
